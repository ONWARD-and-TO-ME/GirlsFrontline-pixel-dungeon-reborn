...
public class WandOfRegrowth extends Wand {
	...
	public void onZap(Ballistica bolt) {
		...
		if (totChrgUsed >= chargeLimit(Dungeon.cur().hero.lvl)){
		...
		if (totChrgUsed < chargeLimit(Dungeon.cur().hero.lvl)) {
			...
			if (totChrgUsed > chargeLimit(Dungeon.cur().hero.lvl)){
				chargesOverLimit = totChrgUsed - chargeLimit(Dungeon.cur().hero.lvl);
				totChrgUsed = chargeLimit(Dungeon.cur().hero.lvl);
			}
		} else {
	...
	public String statsDesc() {
		...
		if (isIdentified()){
			int chargeLeft = chargeLimit(Dungeon.cur().hero.lvl) - totChrgUsed;
