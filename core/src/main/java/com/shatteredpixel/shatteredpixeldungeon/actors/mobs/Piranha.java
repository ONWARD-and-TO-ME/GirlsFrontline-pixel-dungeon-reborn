...
public class Piranha extends Mob {
	...
	public Piranha() {
		...
		HP = HT = 10 + Dungeon.curDepth() * 5;
		defenseSkill = 10 + Dungeon.curDepth() * 2;
	}
	...
	public int damageRoll() {
		return Random.NormalIntRange( Dungeon.curDepth(), 4 + Dungeon.curDepth() * 2 );
	}
	
	@Override
	public int attackSkill( Char target ) {
		return 20 + Dungeon.curDepth() * 2;
	}
	
	@Override
	public int drRoll() {
		return Random.NormalIntRange(0, Dungeon.curDepth());
	}
